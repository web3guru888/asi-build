> **Note:** This is a third-party project included as a reference example.
> MiniMind is an open-source small language model by [MiniMind contributors](https://github.com/jingyaogong/minimind).
> Licensed under Apache 2.0. See [LICENSE](LICENSE) for details.
> Included in ASI:BUILD as an example of minimal LLM architecture.
