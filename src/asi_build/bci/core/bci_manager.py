    ...
    async def calibrate(self, 
        ...
        try:
            ...
            for trial in range(trials):
                ...
                trial_data = await self._collect_calibration_trial(
                    task_type, duration / trials
                )
            ...
            model_params = await self.neural_decoder.train_classifier(
                task_type, calibration_data
            )
            ...
            self.logger.info(f"Calibration completed for {task_type}, "
    ...
    def export_session_data(self, session_id: str, format: str = 'json') -> Optional[str]:
        ...
        try:
            ...
            session_data = {
                ...
                'recorded_data': [d for d in self.recorded_data 
