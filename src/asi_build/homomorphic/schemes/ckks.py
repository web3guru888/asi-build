...
class CKKSScheme(FHECore):
    ...
    def encode(
        self, values: Union[List[complex], np.ndarray], scale: Optional[float] = None
    ) -> CKKSPlaintext:
        """
        Encode complex values into a CKKS plaintext.
    ...
    def encrypt(
        self,
        plaintext: Union[CKKSPlaintext, List, np.ndarray],
    ...
    def decrypt(
        self, ciphertext: CKKSCiphertext, secret_key: Optional[SecretKey] = None
    ) -> CKKSPlaintext:
        """
    ...
    def add_plain(
        self, ciphertext: CKKSCiphertext, plaintext: Union[CKKSPlaintext, List, np.ndarray, complex]
    ) -> CKKSCiphertext:
        """
    ...
    def dot_product(
        self, ciphertext1: CKKSCiphertext, ciphertext2: CKKSCiphertext
    ) -> CKKSCiphertext:
        """
    ...
    def polynomial_evaluation(
        self, ciphertext: CKKSCiphertext, coefficients: List[complex]
    ) -> CKKSCiphertext:
        """
    ...
    def matrix_vector_multiply(
        self, matrix_rows: List[CKKSCiphertext], vector: CKKSCiphertext
    ) -> List[CKKSCiphertext]:
        """
