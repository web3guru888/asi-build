...
class EncryptedTrainer:
    ...
    def sgd_step(self, weights: CKKSCiphertext, gradients: CKKSCiphertext, 
                learning_rate: float) -> CKKSCiphertext:
    ...
    def adam_step(self, weights: CKKSCiphertext, gradients: CKKSCiphertext,
                 m: CKKSCiphertext, v: CKKSCiphertext, 
                 learning_rate: float, beta1: float = 0.9, beta2: float = 0.999,
                 epsilon: float = 1e-8, t: int = 1) -> tuple:
...
class FederatedLearning:
    ...
    def secure_aggregation(self, client_updates: List[CKKSCiphertext],
