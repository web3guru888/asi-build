...
class EncryptedMetrics:
    ...
    def encrypted_mse(self, y_true: CKKSCiphertext, y_pred: CKKSCiphertext) -> CKKSCiphertext:
        """
    ...
    def encrypted_mae(self, y_true: CKKSCiphertext, y_pred: CKKSCiphertext) -> CKKSCiphertext:
        """
    ...
    def encrypted_accuracy(
        self, y_true: CKKSCiphertext, y_pred: CKKSCiphertext, threshold: float = 0.5
    ) -> CKKSCiphertext:
        """
    ...
    def encrypted_r2_score(self, y_true: CKKSCiphertext, y_pred: CKKSCiphertext) -> CKKSCiphertext:
        """
    ...
    def encrypted_confusion_matrix_elements(
        self, y_true: CKKSCiphertext, y_pred: CKKSCiphertext, threshold: float = 0.5
    ) -> Dict[str, CKKSCiphertext]:
        """
    ...
    def _step_function_approx(self, x: CKKSCiphertext, threshold: CKKSCiphertext) -> CKKSCiphertext:
    ...
    def encrypted_precision_recall(
        self, confusion_elements: Dict[str, CKKSCiphertext]
    ) -> Dict[str, CKKSCiphertext]:
        """
    ...
    def encrypted_f1_score(
        self, precision: CKKSCiphertext, recall: CKKSCiphertext
    ) -> CKKSCiphertext:
        """
