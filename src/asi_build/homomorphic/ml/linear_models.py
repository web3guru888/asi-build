...
class EncryptedLinearRegression:
    ...
    def fit_encrypted(
        self,
        X_encrypted: List[CKKSCiphertext],
        ...
        for iteration in range(self.config.max_iterations):
            ...
            for i, (x_sample, y_sample, pred) in enumerate(
                zip(X_encrypted, [y_encrypted] * n_samples, predictions)
            ):
                # error = pred - y_sample
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        info = {
            ...
            "training_history": {
                ...
                "final_loss": (
                    self.training_loss_history[-1] if self.training_loss_history else None
                ),
            },
        }
