...
class EncryptedInference:
    ...
    def __init__(self, scheme: CKKSScheme):
        ...
        self.performance_stats = {"total_inferences": 0, "total_time": 0.0, "cache_hits": 0}
    ...
    def get_performance_stats(self) -> Dict[str, Any]:
        ...
        avg_time = self.performance_stats["total_time"] / max(
            1, self.performance_stats["total_inferences"]
        )

        cache_rate = self.performance_stats["cache_hits"] / max(
            1, self.performance_stats["total_inferences"]
        )
