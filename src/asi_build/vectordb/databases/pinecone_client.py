...
class PineconeClient:
        ...
        try:
            ...
            for i in range(0, len(vectors), batch_size):
                ...
                for vec_id, vector, metadata in batch:
                    upsert_data.append({"id": vec_id, "values": vector, "metadata": metadata or {}})
    ...
    def update_metadata(self, vec_id: str, metadata: Dict[str, Any], namespace: str = "") -> bool:
        """
        ...
        try:
            self._index.update(id=vec_id, set_metadata=metadata, namespace=namespace)
    ...
    def similarity_search(
        ...
        results = self.query_vectors(
            query_vector=query_vector, top_k=top_k, namespace=namespace, filter_dict=filter_dict
        )
    ...
    def batch_query(
        ...
        namespace: str = "",
        filter_dict: Optional[Dict[str, Any]] = None,
    ) -> List[List[PineconeSearchResult]]:
        """
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if connected:
                ...
                return {"status": "disconnected", "connected": False, "available_indexes": indexes}
