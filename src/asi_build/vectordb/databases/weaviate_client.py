...
class WeaviateClient:
    ...
    def insert_objects(self,
                      ...
                      batch_size: int = 100,
                      vector_field: Optional[str] = None) -> bool:
        """
    ...
    def semantic_search(self,
                       ...
                       with_vector: bool = False) -> List[WeaviateSearchResult]:
        """
    ...
    def hybrid_search(self,
                     ...
                     top_k: int = 10,
                     where_filter: Optional[Dict] = None,
                     properties: Optional[List[str]] = None) -> List[WeaviateSearchResult]:
        """
    ...
    def get_object_by_id(self,
                        ...
                        properties: Optional[List[str]] = None,
                        with_vector: bool = False) -> Optional[WeaviateSearchResult]:
        """
        Get object by ID.
    ...
    def delete_objects(self,
                      class_name: str,
                      where_filter: Optional[Dict] = None,
                      obj_ids: Optional[List[str]] = None) -> bool:
        """
