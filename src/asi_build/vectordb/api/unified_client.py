...
from ..core.search import SemanticSearchEngine, SearchQuery, SearchResult
...
class UnifiedVectorDB:
    ...
    def insert_documents(self,
                        ...
                        replicate_across_dbs: bool = True) -> InsertionResult:
        """
    ...
    def _insert_pinecone(self, documents: List[Dict[str, Any]], embeddings: List[List[float]]) -> bool:
    ...
    def _insert_weaviate(self, documents: List[Dict[str, Any]], embeddings: List[List[float]]) -> bool:
    ...
    def _insert_qdrant(self, documents: List[Dict[str, Any]], embeddings: List[List[float]]) -> bool:
    ...
    def delete_documents(self,
                        ...
                        database_preference: Optional[List[str]] = None) -> Dict[str, bool]:
        """
    ...
    def get_document(self,
                    document_id: str,
                    database_preference: Optional[List[str]] = None,
                    include_vector: bool = False) -> Optional[SearchResult]:
        """
