    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "managers": {
                ...
                and self.visualization_manager.is_enabled(),
                "telepresence": self.telepresence_manager is not None
                and self.telepresence_manager.is_enabled(),
                ...
                and self.security_manager.is_enabled(),
                "networking": self.networking_manager is not None
                and self.networking_manager.is_enabled(),
            },
        }
