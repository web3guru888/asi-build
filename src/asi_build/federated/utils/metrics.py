...
class PerformanceTracker:
    ...
    def record_round_completion(self, round_time: float, num_clients: int):
        ...
        self.logger.debug(
            f"Round completed in {round_time:.2f}s, throughput: {throughput:.2f} rounds/s"
        )
    ...
    def get_efficiency_metrics(self) -> Dict[str, Any]:
        ...
        if self.round_times and self.aggregation_times:
            ...
            aggregation_efficiency = (
                total_aggregation_time / total_round_time if total_round_time > 0 else 0
            )
        ...
        if self.round_times and self.communication_times:
            ...
            communication_efficiency = (
                total_communication_time / total_round_time if total_round_time > 0 else 0
            )
