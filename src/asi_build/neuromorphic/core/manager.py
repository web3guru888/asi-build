...
class NeuromorphicManager:
    ...
    def start_simulation(self, duration: Optional[float] = None, real_time: bool = False) -> bool:
        ...
        try:
            ...
            sim_duration = min(duration or self.max_simulation_time, self.max_simulation_time)

            # Start simulation thread
            self._simulation_thread = threading.Thread(
                target=self._simulation_loop, args=(sim_duration, real_time), daemon=True
            )
            self._simulation_thread.start()

            self.logger.info(
                f"Started simulation (duration: {sim_duration}s, " f"real_time: {real_time})"
            )
            return True
    ...
    def get_component_info(self) -> Dict[str, Any]:
        ...
        info = {"networks": {}, "processors": {}, "interfaces": {}}
