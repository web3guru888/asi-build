    ...
    try:
        with driver.session() as session:
            ...
            for record in result:
                ...
                print(
                    f"  ✅ Workflow: {record['name']} - {record['rate']*100:.0f}% success ({record['count']} runs)"
                )
            ...
            for record in result:
                ...
                print(
                    f"  ✅ Error '{record['error']}' resolved by {record['pattern']} (confidence: {record['confidence']:.2f})"
                )
            ...
            for record in result:
                ...
                print(
                    f"  ✅ After '{record['current']}' → predict '{record['predicted']}' (frequency: {record['frequency']})"
                )
