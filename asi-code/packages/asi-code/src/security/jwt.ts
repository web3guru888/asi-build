...
export function createDefaultJWTConfig(): JWTConfig {
  return {
    accessTokenSecret: process.env.JWT_ACCESS_SECRET || JWTManager.generateSecret(64),
    refreshTokenSecret: process.env.JWT_REFRESH_SECRET || JWTManager.generateSecret(64),
