...
class Bulletproofs:
    ...
    def range_proof(self, value: int, bit_length: int) -> Dict[str, Any]:
        ...
        for bit in bits:
            ...
            commit = (pow(self.generator, bit, self.prime) * 
                     pow(self.h_generator, r, self.prime)) % self.prime
    ...
    def verify_range_proof(self, proof: Dict[str, Any], 
                          value_commitment: int) -> bool:
