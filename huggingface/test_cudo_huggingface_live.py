...
# Configuration
CUDO_API_KEY = os.getenv("CUDO_API_KEY", "a661306311d02d22e5a35f02b14ab2203b856906b326d029867a6733530860d0")
...
async def comprehensive_integration_test(dry_run=True):
    ...
    try:
        ...
        test_results["tests"]["cudo_vm_creation"] = {
            ...
            "status": "✅ PASSED" if vm_result and vm_result.get("status") in ["dry_run", "running"] else "❌ FAILED"
        }
