...
class VectorUtils:
    ...
    def batch_cosine_similarity(query_vector: Union[List[float], np.ndarray],
                               vectors: List[Union[List[float], np.ndarray]]) -> List[float]:
        """
    ...
    @staticmethod
    def find_top_k_similar(query_vector: Union[List[float], np.ndarray],
    ...
    @staticmethod
    def cluster_vectors(vectors: List[Union[List[float], np.ndarray]],
                       n_clusters: int = 10,
