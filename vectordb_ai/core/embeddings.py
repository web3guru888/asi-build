...
class EmbeddingPipeline:
    ...
    def generate_embeddings(self, texts: Union[str, List[str]], use_cache: bool = True) -> EmbeddingResult:
        """
        ...
        if uncached_texts:
            logger.info(f"Generating embeddings for {len(uncached_texts)} texts using {self.model.model_name}")
