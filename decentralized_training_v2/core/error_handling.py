...
class ErrorHandler:
    ...
    def _escalate_error(self, error_info: ErrorInfo, error_count: int):
        ...
        self.logger.critical(escalation_message, extra={
    ...
    def get_error_summary(self, hours: int = 24) -> Dict[str, Any]:
        ...
        return {
            ...
            'most_problematic_component': max(by_component, key=by_component.get) if by_component else None
        }
...
class HealthChecker:
        ...
        for name, check_info in self.health_checks.items():
            if current_time - check_info['last_run'] >= check_info['interval']:
                try:
                    ...
                    severity = ErrorSeverity.CRITICAL if check_info['critical'] else ErrorSeverity.HIGH
    ...
    def get_overall_health(self) -> Dict[str, Any]:
        ...
        critical_unhealthy = sum(1 for status in self.health_status.values()
