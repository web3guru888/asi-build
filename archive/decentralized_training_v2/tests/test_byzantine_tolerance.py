...
from ..core.byzantine_tolerance import (
    ByzantineDetector, ByzantineTolerantAggregator, AdaptiveByzantineDefense,
    AttackType, NodeBehavior, AggregationResult
)
...
class TestByzantineDetector:
    ...
    def test_cosine_similarity_calculation(self, detector_config):
        ...
        grad3 = {'param': torch.tensor([1., 0., 0., 0., 0.])}
        grad4 = {'param': torch.tensor([0., 1., 0., 0., 0.])}
    ...
    def test_trusted_nodes_selection(self, detector_config):
        ...
        trusted = detector.get_trusted_nodes(['trusted_1', 'trusted_2', 'untrusted'], min_trust_score=0.5)
...
class TestByzantineTolerantAggregator:
    ...
    async def test_aggregation_with_malicious_nodes(self, aggregator_config, malicious_gradients):
        ...
        assert 'malicious_1' in result.suspected_byzantine or 'malicious_2' in result.suspected_byzantine
...
class TestByzantineTolerancePerformance:
    ...
    async def test_detection_performance(self, detector_config):
        ...
        print(f"Byzantine detection for 50 nodes with large gradients: {detection_time:.2f} seconds")
