...
class BCIConfig:
    ...
    motor_imagery: Dict[str, Any] = field(default_factory=lambda: {
    ...
    p300: Dict[str, Any] = field(default_factory=lambda: {
    ...
    ssvep: Dict[str, Any] = field(default_factory=lambda: {
    ...
    neurofeedback: Dict[str, Any] = field(default_factory=lambda: {
        'target_bands': {
            'theta': (4, 8),
            'alpha': (8, 12),
            'beta': (12, 30)
    ...
    def validate(self) -> List[str]:
        ...
        if self.classification.confidence_threshold < 0 or self.classification.confidence_threshold > 1:
    ...
    def __repr__(self) -> str:
        return f"BCIConfig(device={self.device.device_type}, " \
