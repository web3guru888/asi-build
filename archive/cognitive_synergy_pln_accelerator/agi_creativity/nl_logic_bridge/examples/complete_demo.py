...
async def demonstrate_interactive_interface():
    ...
    print(f"   Success rate: {session_stats.get('success_count', 0) / max(session_stats.get('query_count', 1), 1) * 100:.1f}%")
